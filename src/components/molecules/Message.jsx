...
const Message = ({ message }) => {
    return (
        <div className={message.role === "user" ? 'mx-auto w-3/4 text-white pt-8 flex flex-row-reverse animate__animated animate__fadeIn' : 'mx-auto w-3/4 text-white pt-8 flex animate__animated animate__fadeIn'}>
            {message.role === "user" ?
