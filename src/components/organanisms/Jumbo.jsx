...
const Jumbo = () => {
    return (
        <section className="movingBg bg-center bg-no-repeat bg-gray-700 bg-blend-multiply h-screen flex items-center">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 flex flex-col">
