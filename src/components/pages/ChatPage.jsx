    ...
    return (
        <div className='h-screen bg-primary'>
            ...
            {messages.map((message, index) => (
                <div key={index} className={message.sender === "user"? 'mx-auto w-3/4 text-white pt-8 flex flex-row-reverse animate__animated animate__fadeIn':'mx-auto w-3/4 text-white pt-8 flex animate__animated animate__fadeIn' } >
                    {message.sender === "user" ?
